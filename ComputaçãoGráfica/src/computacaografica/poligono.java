...
public class poligono extends JFrame  {
	...
	private int[] Pontos_x = {86, 300, 300, 390, 400, 320, 400, 410, 300, 300, 250, 200, 180}; /*cordenadas x dos vertices*/
	private int[] Pontos_y = {48, 50, 150, 150,160, 200, 200, 240, 250, 360, 300, 360, 270}; /*cordenadas y dos vertices*/
	   private int Pontos_n = 13;/*numero de vertice*/
